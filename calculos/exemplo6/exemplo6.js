function calcular() {
    ...
    if (!isNaN(massa1) && !isNaN(massa2) && !isNaN(massa3) && !isNaN(coeficiente1) && !isNaN(forca) && !isNaN(gravidade)) {
        ...
        if (forca >= forcaAtritoTotal) {
            ...
            var resultado = document.getElementById("resultado");
                resultado.innerHTML = "Aceleração: " + aceleracao.toFixed(2) + " m/s²<br>Força de A em B: " + forcaBA.toFixed(2) + " N<br>Força de B em C: " + forcaBC.toFixed(2) + " N<br>Força de atrito Corpo 1: " + forcaAtrito1.toFixed(2) + " N<br>Força de atrito Corpo 2: " + forcaAtrito2.toFixed(2) + " N<br>Força de atrito Corpo 3: " + forcaAtrito3.toFixed(2) + " N<br>Valor mínimo para força aplicada para empurrar os blocos: " + forcaAtritoTotal.toFixed(2) + " N";
        }
        } else {
            var resultado = document.getElementById("resultado");
